       							...
       							<div id="testimonial-slider" class="owl-carousel owl-theme">
       								<div class="row">
       									...
       									<div class="col-md-6 ">
       										<div class="testimonial">
       											<div class="testimonial-meta" style="padding-top: 30px;">
       												...
       												<h3 class="white-text" style="margin-left: 130px;">Nama Pakar</h3>
       												<span style="margin-left: 130px;">Jabatan Pakar</span>
       											</div>
       									...
       									<div class="col-md-6">
       										...
       										<span>Jl. nanti aja</span><br>
       										<span style="color: white;">Prakter : </span><br>
       										<span>atau kerja dimana</span><br>
       										<span style="color: white;">Pengalaman Kerja : </span><br>
       										<span>1. Tempat Bekerja Dan Tempat Praktek</span><br>
